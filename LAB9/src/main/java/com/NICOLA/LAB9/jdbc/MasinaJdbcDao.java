...
public class MasinaJdbcDao {
    ...
    public List<Masina> findAll() {
        return jdbcTemplate.
                query("select * from masini", new MasinaMapper());
    }

    public int insert(Masina masina) {
        return jdbcTemplate.
                update("insert into masini (nr_inmatriculare, marca, anul_fabricatiei, culoare, nr_km) values(?, ?, ?, ?, ?)",
    ...
    public int update(Masina masina) {
        return jdbcTemplate.
                update("update masini set marca = ?, anul_fabricatiei = ?, culoare = ?, nr_km = ? where nr_inmatriculare = ?",
    ...
    public int deleteById(String nrInmatriculare) {
        return jdbcTemplate.
                update("delete from masini where nr_inmatriculare = ?", new Object[]{nrInmatriculare});
    }

    public Masina findById(String nrInmatriculare) {
        return jdbcTemplate.
                queryForObject("select * from masini where nr_inmatriculare = ?", new Object[]{nrInmatriculare}, new MasinaMapper());
    }
